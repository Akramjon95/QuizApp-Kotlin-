    ...
    fun setQuiz(){
        if (index < science.quizList.count()){
            ...
            if (quiz.img != null){
                ...
                imgQuiz.setImageResource(quiz.img)
            } else{
            ...
            Toast.makeText(this, "Siz ${science.quizList.count()} ta savoldan $correctCount taga to'g'ri javob berdingiz", Toast.LENGTH_LONG ).show()
        }
    }
}